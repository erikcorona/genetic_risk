...
int main() {
    ...
    auto t2d = gwas.subsetter("DISEASE/TRAIT","Type 2 diabetes");

    t2d.printSummary();
    std::cout << "Unique RSIDs for t2d: " << t2d.uniqueRSIDs().size() << std::endl;

    auto t2d6 = t2d.subsetter("CHR_ID","6");
